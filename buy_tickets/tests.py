...
class AirTicketTest(APITestCase):
    def setUp(self):
        ...
        self.token = '12345'
        airtickets = [
            AirTicket(passenger=user, departure_city='new zealand', arrival_city='dubai1',category=self.category),
            AirTicket(passenger=user, departure_city='new zealnad11',arrival_city='dubai2',category=self.category)
        ]
